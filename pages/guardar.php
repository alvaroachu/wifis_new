    ...
    <script>
        $(document).ready(function() {
            ...
            $('#ssids, #comments').keyup(function() {
                var cont1 = $('#ssids').val().trim(),
                    cont2 = $('#comments').val().trim(),
                    tabla = $('#tablaList');
                tabla.find('td.col3:contains(' + cont1 + ')')
                    .removeClass('no_cumple')
                    .addClass('cumple');
                tabla.find('td.col6:contains(' + cont2 + ')')
                    .removeClass('no_cumple')
                    .addClass('cumple');
                tabla.find('td.col3:not(:contains(' + cont1 + '))')
                    .addClass('no_cumple')
                    .removeClass('cumple');
                tabla.find('td.col6:not(:contains(' + cont2 + '))')
                    .addClass('no_cumple')
                    .removeClass('cumple');
                tabla.find('tr').removeClass('fila_eliminar').show();
